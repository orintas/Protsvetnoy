...
<div style="display:flex;align-items:center;gap:14px"><button class="gear-btn small open-categories" type="button" aria-label="Категории синхронизации" title="Категории синхронизации">⚙</button><span class="accordion-chevron">▸</span></div>
</div>
