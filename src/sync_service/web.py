...
<p class="muted" style="margin:0 0 10px">Только для 4 магазинов rFBS (ТМ Авиапарк, ТЦ Саларис, ТЦ Ривьера, ТЦ МЕГА Химки) — отправления с Основного склада (обычный FBS) вебхук игнорирует, этикетки по ним в Telegram не уходят. OZON присылает вебхук на каждое событие по отправлению. При новом отправлении (<code>TYPE_NEW_POSTING</code>) сервис:</p>
<ol class="muted" style="margin:0 0 14px;padding-left:20px;line-height:1.7">
<li>Проверяет склад отправления — если это не один из 4 магазинов rFBS, просто подтверждает получение вебхука и ничего не делает.</li>
<li>Иначе ставит номер отправления в очередь и сразу отвечает OZON — у него всего 5 секунд на ответ, вся дальнейшая работа идёт в фоне.</li>
